...
// GHRS აიქონები
export function Categories(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#5750F1" />
      <path
        d="M39.833 21.75H18.167c-.9 0-1.625.725-1.625 1.625v13c0 .9.725 1.625 1.625 1.625h21.666c.9 0 1.625-.725 1.625-1.625v-13c0-.9-.725-1.625-1.625-1.625z"
        fill="#fff"
      />
      <path
        d="M23.25 26.125h4.875v3.25H23.25v-3.25zM30.875 26.125h4.875v3.25h-4.875v-3.25z"
        fill="#5750F1"
      />
    </svg>
  );
...
export function Videos(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#FF6B6B" />
      <path
        d="M39.833 19.5H18.167c-1.8 0-3.25 1.45-3.25 3.25v13c0 1.8 1.45 3.25 3.25 3.25h21.666c1.8 0 3.25-1.45 3.25-3.25v-13c0-1.8-1.45-3.25-3.25-3.25z"
        fill="#fff"
      />
      <path
        d="M26.125 24.375l6.5 4.875-6.5 4.875v-9.75z"
        fill="#FF6B6B"
      />
    </svg>
  );
...
export function Blogs(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#4ECDC4" />
      <path
        d="M36.625 18.166H21.375c-1.8 0-3.25 1.45-3.25 3.25v17.334c0 .9.725 1.625 1.625 1.625h18.5c.9 0 1.625-.725 1.625-1.625V21.416c0-1.8-1.45-3.25-3.25-3.25z"
        fill="#fff"
      />
      <path
        d="M23 26.125h12v1.625H23v-1.625zM23 29.375h12v1.625H23v-1.625zM23 32.625h8.125v1.625H23v-1.625z"
        fill="#4ECDC4"
      />
    </svg>
  );
...
export function Subcategories(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#45B7D1" />
      <path
        d="M37.583 19.5H28.5c-.9 0-1.625.725-1.625 1.625v6.5c0 .9.725 1.625 1.625 1.625h9.083c.9 0 1.625-.725 1.625-1.625v-6.5c0-.9-.725-1.625-1.625-1.625zM29.5 28.75H20.417c-.9 0-1.625.725-1.625 1.625v6.5c0 .9.725 1.625 1.625 1.625H29.5c.9 0 1.625-.725 1.625-1.625v-6.5c0-.9-.725-1.625-1.625-1.625zM18.792 19.5c-.9 0-1.625.725-1.625 1.625v6.5c0 .9.725 1.625 1.625 1.625h6.5c.9 0 1.625-.725 1.625-1.625v-6.5c0-.9-.725-1.625-1.625-1.625h-6.5z"
        fill="#fff"
      />
    </svg>
  );
...
export function Sets(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#96CEB4" />
      <path
        d="M36.625 19.5c-1.8 0-3.25 1.45-3.25 3.25v13c0 1.8 1.45 3.25 3.25 3.25s3.25-1.45 3.25-3.25v-13c0-1.8-1.45-3.25-3.25-3.25zM21.375 19.5c-1.8 0-3.25 1.45-3.25 3.25v13c0 1.8 1.45 3.25 3.25 3.25s3.25-1.45 3.25-3.25v-13c0-1.8-1.45-3.25-3.25-3.25zM29 22.75c-1.8 0-3.25 1.45-3.25 3.25v6.5c0 1.8 1.45 3.25 3.25 3.25s3.25-1.45 3.25-3.25V26c0-1.8-1.45-3.25-3.25-3.25z"
        fill="#fff"
      />
    </svg>
  );
...
export function Courses(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#FECA57" />
      <path
        d="M29 18.167L18.167 23.25L29 28.333l10.833-5.083L29 18.167z"
        fill="#fff"
      />
      <path
        d="M18.167 32.5L29 37.583l10.833-5.083"
        stroke="#fff"
        strokeWidth="2"
        strokeLinecap="round"
      ...
      />
      <path
        d="M18.167 26L29 31.083L39.833 26"
        stroke="#fff"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function Sessions(props: SVGPropsType) {
  return (
    <svg width={58} height={58} viewBox="0 0 58 58" fill="none" {...props}>
      <circle cx={29} cy={29} r={29} fill="#A8E6CF" />
      <path
